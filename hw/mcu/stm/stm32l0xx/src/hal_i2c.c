...
struct stm32l0_hal_i2c {
    I2C_HandleTypeDef hid_handle;
};

#if MYNEWT_VAL(I2C_0)
static struct stm32l0_hal_i2c i2c0;
#endif
#if MYNEWT_VAL(I2C_1)
static struct stm32l0_hal_i2c i2c1;
#endif
#if MYNEWT_VAL(I2C_2)
static struct stm32l0_hal_i2c i2c2;
#endif

static struct stm32l0_hal_i2c *hal_i2c_devs[HAL_I2C_MAX_DEVS] = {
#if MYNEWT_VAL(I2C_0)
    &i2c0,
#else
    NULL,
...
{
    struct stm32l0_hal_i2c_cfg *cfg = (struct stm32l0_hal_i2c_cfg *)usercfg;
    struct stm32l0_hal_i2c *dev;
...
/* XXXXX    init->ClockSpeed = cfg->hic_speed; */
    if (cfg->hic_10bit) {
