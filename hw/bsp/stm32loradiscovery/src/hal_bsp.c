...
static const struct stm32l0_uart_cfg uart_cfg0 = {
    .suc_uart = USART2,
    .suc_rcc_reg = &RCC->APB1ENR,
    .suc_rcc_dev = RCC_APB1ENR_USART2EN,
    .suc_pin_tx = MCU_GPIO_PORTA(3),
    .suc_pin_rx = MCU_GPIO_PORTA(2),
    .suc_pin_rts = -1,
    .suc_pin_cts = -1,
...
static const struct stm32l0_uart_cfg uart_cfg1 = {
    .suc_uart = USART1,
    ...
    .suc_pin_rts = -1,
    .suc_pin_cts = -1,
    .suc_pin_af = GPIO_AF4_USART1,
    .suc_irqn = USART1_IRQn
};
#endif

#if MYNEWT_VAL(I2C_0)
static struct stm32l0_hal_i2c_cfg i2c_cfg0 = {
    .hic_i2c = I2C1,
...
#if MYNEWT_VAL(UART_1)
    rc = os_dev_create((struct os_dev *) &hal_uart0, "uart1",
